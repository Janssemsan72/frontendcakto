  ...
  const features = [
    {
      ...
      description: "Sua música fica pronta em até 6h, sem comprometer a qualidade."
    },
    {
      icon: Star,
  ...
  const faq = [
    {
      ...
      answer: "No plano Expresso, sua música fica pronta em até 6h. No plano Padrão, entregamos em até 7 dias."
    },
    {
